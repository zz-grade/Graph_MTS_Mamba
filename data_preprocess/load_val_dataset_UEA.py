...
def stratified_split_indices(labels_np, val_ratio=0.2, seed=0):
    """
    labels_np: (N,) numpy int array
    return: train_idx, val_idx (numpy arrays)
    """
    ...
    for c in classes:
        ...
        val_idx_list.append(idx_c[:n_val])
        train_idx_list.append(idx_c[n_val:])
